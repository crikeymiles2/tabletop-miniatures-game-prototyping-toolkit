...
switch($roll) {
	...
	case 5:
		...
		break;
	case 6:
	echo '<p><strong>[Fungible Activations]</strong> Each player gets 5 Game Tokens. Starting with the First Player, each player selects a unit and spends 1 Game Token to activate the unit, and then passes play to the player to their left. Once all Game Tokens are spent, the phase ends.</p>';
		break;
	case 7:
